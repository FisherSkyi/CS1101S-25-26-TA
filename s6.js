// A tree of a certain data type is a list whose elements are of
// that data type, or trees of that data type
...
remove_duplicates2(list(1, 2, 3, 4, 4, 3, 2, 1, 2));
// Result: list(4, 3, 1, 2)

remove_duplicates2(list("a", "x", "b", "c", "c", "b", "d"));
